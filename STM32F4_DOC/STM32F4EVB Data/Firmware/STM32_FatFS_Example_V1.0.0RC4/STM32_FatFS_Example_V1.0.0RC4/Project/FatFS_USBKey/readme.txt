/**
  @page FatFS_USBKey   FatFS example in single drive(USB Key) configuration
  
  @verbatim
  ******************** (C) COPYRIGHT 2012 STMicroelectronics *******************
  * @file    Project\FatFS_USBKey\readme.txt 
  * @author  MCD Application Team
  * @version V1.0.0RC4
  * @date    21-December-2012
  * @brief   Description of the FatFS example in single drive(USB Key) configuration.
  ******************************************************************************
  * @attention
  *
...
This example illustrates how to use the FatFS in single drive(USB Key) configuration. 

The principle of the example, built around FatFS R0.09, is quite simple:
 - Mount the FatFS on the USB Key drive.
 - Open for write.
